...
export default function PersonalInfoSection() {
  const MyInfos = [
    {
      label: "Tanggal Lahir",
      value: "Bandung, 14 November 2003",
      icon: <FaBirthdayCake />,
    },
    { label: "Jenis Kelamin", value: "Laki-laki", icon: <FaMars /> },
    { label: "Tinggi Badan", value: "169 cm", icon: <FaRulerVertical /> },
    { label: "Berat Badan", value: "55 kg", icon: <FaWeight /> },
    { label: "Status Pernikahan", value: "Belum Menikah", icon: <FaHeart /> },
    { label: "Whatsapp", value: "+6281214605521", icon: <FaWhatsapp /> },
    { label: "Email", value: "novianfadhilah@gmail.com", icon: <FaEnvelope /> },
  ];
