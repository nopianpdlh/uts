  ...
  return (
    <div className="container mx-auto p-2 text-center pt-20">
      ...
      <div className="border-2 border-indigo-400/75 rounded-lg bg-stone-200 p-2 my-5">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-1">
            ...
            <div className="col-span-12 md:col-span-4">SDN 2 Tenjolaya</div>
      ...
      <div className="border-2 border-indigo-400/75 rounded-lg bg-stone-200 p-2 my-5">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-1">
            ...
            <div className="col-span-12 md:col-span-4">SMPN 1 Cicalengka</div>
      ...
      <div className="border-2 border-indigo-400/75 rounded-lg bg-stone-200 p-2 my-5">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-1">
            ...
            <div className="col-span-12 md:col-span-4">SMAN 1 Cicalengka</div>
      ...
      <div className="border-2 border-indigo-400/75 rounded-lg bg-stone-200 p-2 my-5">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-1">
            <div className="col-span-12 md:col-span-4">Perguruan Tinggi</div>
...
function RowRiwayat(props: RowRiwayatProps) {
  return (
    <div className="border-2 border-indigo-600/75 rounded-lg bg-stone-200 p-2 my-5">
      <div className="container mx-auto">
